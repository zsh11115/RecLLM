Base_Prompt_GPT41 = """
### Task
we provide a sequence of items in [Sequence Item Profile] that the user has interacted with. Your task is to analyze these items and produce an updated profile that reflects any new preferences, or insights inferred from the user's interactions with these items.
...
6. Be comprehensive and specific in your summarization, focusing on the finer attributes and features of the items that relate to the user's preferences.
...
Update_Prompt_GPT41 = """
### Task
We provide a user's personal profile in [User Profile], which includes the user's preferences and other relevant information. Additionally, we provide a sequence of items in [Sequence Item Profile] that the user has interacted with. Your task is to analyze these items in the context of the user's existing profile and produce an updated profile that reflects any new preferences, or insights inferred from the user's interactions with these items.
